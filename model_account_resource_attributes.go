...
type AccountResourceAttributes struct {
	...
	AccountType NullableAccountTypeEnum `json:"accountType"`
	// The ownership structure for this account. 
	OwnershipType NullableOwnershipTypeEnum `json:"ownershipType"`
	Balance AccountResourceAttributesBalance `json:"balance"`
...
func (o *AccountResourceAttributes) GetBalance() AccountResourceAttributesBalance {
	if o == nil {
		var ret AccountResourceAttributesBalance
		return ret
	}
...
func (o AccountResourceAttributes) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["ownershipType"] = o.OwnershipType.Get()
	}
	if true {
